        ...
        <div>
            ...
            <div class="row win">
                ...
                <p><span class="fw-bold">Smarty:</span> 5-step lookahead algorithm. This feels like a real human (if
                    slightly drunk)
                    opponent. It beats Silly in 60% of cases.</p>
                <p><span class="fw-bold">Prophet:</span> 7-step lookahead algorithm. It beats Smarty and Silly in 100%
                    of cases. She is a nasty player.</p>
                <p><span class="fw-bold">Goddess:</span> 9-step lookahead algorithm. She has Prophet for breakfast.</p>
                <p><span class="fw-bold">Bitch:</span> 11-step lookahead algorithm. She nevers loses against Goddess,
                    but it will tie if playing second.</p>
                <p>Bit-board optimization would allow to use 13 or 15 step lookahead before blocking the JS thread, but
                    I run out of names for agents ...</p>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-12 my-2">
                        ...
                        <p>Bit-board idea taken from <a
                                href="http://blog.gamesolver.org/solving-connect-four/06-bitboard/"
                                target="_blank">Pascal Pons</a>. You should check it, I use 49 bits (yes bits) to
                            represent the board.</p>
                    </div>
